...
<head>
    ...
    <title>Divine Planners - Manage Caterer | Caterer Panel</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Manage Caterer</h1>
                <ol class="breadcrumb">
            ...
            <div class="page-content fade-in-up">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Caterer List</div>
                    </div>
                    <div class="ibox-body">
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-primary font-weight-bold"><?php echo "Company Id-".$result['caterer_id']; ?></td>
                                    <td><img src="<?php echo $result['company_image'] ?>" height="70" alt="caterer_img"></td>
                                    ...
                                    <td>
                                        <a href="catering_service_payment.php?caterer_id=<?php echo $result['caterer_id']; ?>" class="btn btn-success btn-rounded btn-sm">Make Payment</a>
                                    </td>
                                    <td>
                                        <a href="update_caterer_details.php?caterer_id=<?php echo $result['caterer_id']; ?>" title="update" class="btn btn-info btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-pencil"></i></a> <a href="delete_data.php?caterer_id=<?php echo $result['caterer_id']; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                                <?php }else{ ?>
