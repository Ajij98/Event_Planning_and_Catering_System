...
<!--Update Catering Service Details -->
  <?php
    error_reporting( error_reporting() & ~E_NOTICE );
    $db = new Database();
    $current_datetime = date("Y-m-d") . ' ' . date("H:i:s", STRTOTIME(date('h:i:sa')));
   ...
   if(isset($_POST['update']))
   {
         ...
         <script type="text/javascript">
           ...
           window.alert("Caterer details updated successfully.");
...
<head>
    ...
    <title>Divine Planners - Update Caterer Details | Caterer Panel</title>
    ...
    <div class="page-wrapper">
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="manage_caterer.php"><i class="sidebar-item-icon fa fa-list-ul"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Update Caterer Details</h1>
                <ol class="breadcrumb">
            ...
            <div class="page-content fade-in-up">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Caterer Details</div>
