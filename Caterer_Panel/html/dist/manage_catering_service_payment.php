<?php
 ...
 <?php
   ...
   $db              = new Database();
   $sql             = "SELECT * FROM tb_caterer_payment WHERE added_by = '$user_name'";
    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-content fade-in-up">
                ...
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Catering Payment List</div>
                    </div>
                    <div class="ibox-body">
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo $result['payment_screenshot']; ?>" height="100" alt="payment_ss"></td>
                                    ...
                                    <td>
                                        <a href="#" title="update" class="btn btn-info btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-pencil"></i></a> <a href="delete_data.php?payment_id=<?php echo $result['payment_id']; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                                <?php }else{ ?>
