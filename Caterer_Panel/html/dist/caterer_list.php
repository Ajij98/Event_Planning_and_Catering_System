...
<head>
    ...
    <title>Divine Planners - Caterer List | Caterer Panel</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Caterer List</h1>
                <ol class="breadcrumb">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="add_catering_package.php?caterer_id=<?php echo $result['caterer_id']; ?>" class="btn btn-primary px-2 py-1" style="border-radius: 3px;"><i class="fa fa-plus"></i> Add Package</a>
                                    </td>
