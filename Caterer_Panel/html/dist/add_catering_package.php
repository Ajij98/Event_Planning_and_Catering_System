<?php
 ...
 <?php
   ...
   {    
         $catering_service_code = rand(100000, 999999);
         ...
         $sql = "INSERT INTO tb_catering_package(catering_service_code,company_id,company_name,company_code,contact_number,email_address,package_name,package_price,package_details,package_added_on,added_by,entry_time)values('$catering_service_code','$caterer_id','$company_name','$company_code','$contact_number','$email_address','$package_name','$package_price','$package_details','$package_added_on','$added_by','$current_datetime')";
         ...
         if($insert_row)
         {
           ...
           <script type="text/javascript">
             window.alert("Catering Package details added successfully.");
  ...
  <!-- Catering Package Table Data Load -->
 <?php
   $user_name       = $_SESSION['user_name'];
   $db              = new Database();
   $sql             = "SELECT * FROM tb_catering_package WHERE added_by = '$user_name'";
...
<head>
    ...
    <title>Divine Planners - Add Catering Package | Caterer Panel</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Add Catering Package</h1>
                <ol class="breadcrumb">
            ...
            <div class="page-content fade-in-up">
                ...
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Catering Package List</div>
                    </div>
                    <div class="ibox-body">
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-primary font-weight-bold"><?php echo "Package Id-".$result['catering_service_id']; ?></td>
                                    <td><?php echo $result['catering_service_code']; ?></td>
                                    ...
                                    <td>
                                        <a href="update_catering_package_details.php?catering_service_id=<?php echo $result['catering_service_id']; ?>&caterer_id=<?php echo $caterer_id; ?>" title="update" class="btn btn-info btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-pencil"></i></a> <a href="delete_data.php?catering_service_id=<?php echo $result['catering_service_id']; ?>&caterer_id=<?php echo $caterer_id; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                                <?php }else{ ?>
