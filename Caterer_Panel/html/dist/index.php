<?php
 ...
 ?>
    ...
    <!-- Total Catering Service Company Count -->
 <?php
     $user_name = $_SESSION['user_name'];
     $db   = new Database();
     $sql  = "SELECT * FROM tb_caterer WHERE added_by = '$user_name'";
     $read_caterer_company = $db->select($sql);
     if($read_caterer_company)
     {
       $total_caterer_company = $read_caterer_company->num_rows;
     }
     else
     {
       $total_caterer_company = 0;
     }
    ?>

    <!-- Total Catering Company Count -->
 <?php
     $user_name = $_SESSION['user_name'];
     $db   = new Database();
     $sql  = "SELECT * FROM tb_event_catering_booking WHERE company_owner = '$user_name'";
 ...
 <?php
     $user_name = $_SESSION['user_name'];
     $db   = new Database();
     $sql  = "SELECT * FROM tb_review WHERE company_owner = '$user_name'";
     $read_customer_review = $db->select($sql);
     if($read_customer_review)
     {
       $total_customer_review = $read_customer_review->num_rows;
     }
     else
     {
...
<head>
    ...
    <title>Divine Planners - Dashboard | Caterer Panel</title>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-info color-white widget-stat">
                            <div class="ibox-body">
                                <h2 class="m-b-5 font-strong"><?php echo $total_caterer_company; ?></h2>
                                <div class="m-b-5">CATERING SERVICE COMPANY</div><i class="fa fa-cutlery widget-stat-icon"></i>
                                <div><small><a href="manage_caterer.php" style="text-decoration: underline;" class="text-light">View Company</a></small></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-warning color-white widget-stat">
                            <div class="ibox-body">
                                <h2 class="m-b-5 font-strong"><?php echo $total_customer_booking; ?></h2>
                                <div class="m-b-5">CUSTOMER BOOKING</div><i class="fa fa-arrow-down widget-stat-icon"></i>
                                <div><small><a href="customer_booking.php" style="text-decoration: underline;" class="text-light">View Booking</a></small></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-danger color-white widget-stat">
                            <div class="ibox-body">
                                <h2 class="m-b-5 font-strong"><?php echo $total_customer_review; ?></h2>
                                <div class="m-b-5">CUSTOMER FEEDBACK</div><i class="fa fa-star-half-o widget-stat-icon"></i>
                                <div><small><a href="customer_feedback.php" style="text-decoration: underline;" class="text-light">View Feedback</a></small></div>
                            </div>
                        </div>
                    </div>
                </div>
