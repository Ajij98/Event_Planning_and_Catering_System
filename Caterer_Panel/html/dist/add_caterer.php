<?php
 ...
 <?php
   ...
   {    
         $caterer_code      = rand(100000, 999999);
         ...
         $sql = "INSERT INTO tb_caterer(caterer_code,company_name,company_image,contact_number,email_address,opening_hour,about_company,company_address,company_services,company_established_on,way_of_payment,bkash_acc_number,nagad_acc_number,added_by,entry_time)values('$caterer_code','$company_name','$dst_db','$contact_number','$email_address','$opening_hour','$about_company','$company_address','$company_services','$company_established_on','$way_of_payment','$bkash_acc_number','$nagad_acc_number','$added_by','$entry_time')";
         ...
         if($insert_row)
         {
           ...
           <script type="text/javascript">
             window.alert("Caterer details added successfully.");
             window.location='add_caterer.php';
           </script>
...
<head>
    ...
    <title>Divine Planners - Add Caterer Details | Caterer Panel</title>
    ...
    <div class="page-wrapper">
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="add_caterer.php"><i class="sidebar-item-icon fa fa-cutlery"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Add Caterer</h1>
                <ol class="breadcrumb">
                        ...
                        <div class="ibox">
                            ...
                            <div class="ibox-body">
                                <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <input type="submit" name="submit" class="btn btn-primary" value="Add Caterer">
                                </form>
