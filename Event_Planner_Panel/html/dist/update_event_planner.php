  ...
  <?php
   ...
   if(isset($_POST['update']))
   {
         ...
         if($company_image != "")
         {
           ...
           $sql = "UPDATE tb_event_planner SET company_name='$company_name',company_image='$dst_db',contact_number='$contact_number',email_address='$email_address',opening_hour='$opening_hour',about_company='$about_company',company_address='$company_address',company_services='$company_services',company_established_on='$company_established_on',way_of_payment='$way_of_payment',bkash_acc_number='$bkash_acc_number',nagad_acc_number='$nagad_acc_number' WHERE event_planner_id = $event_planner_id";
         ...
         <script type="text/javascript">
           ...
           window.alert("Event Planner details updated successfully.");
...
<head>
    ...
    <title>Divine Planners - Update Event Planners | Event Planner Panel</title>
    ...
    <div class="page-wrapper">
                ...
                <ul class="nav navbar-toolbar">
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            ...
                            <span></span>Md Arif<i class="fa fa-angle-down m-l-5"></i></a>
                        <ul class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="profile.html"><i class="fa fa-user"></i><?php echo $_SESSION['user_name']; ?></a>
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="manage_event_planners.php"><i class="sidebar-item-icon fa fa-list-ul"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Update Event Planners Details</h1>
                <ol class="breadcrumb">
                                ...
                                <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <input class="form-control" type="text" name="company_name" placeholder="Company name" value="<?php echo $company_name; ?>" required>
                                        </div>
                                        <div class="col-sm-3 form-group">
                                            <label>Company Image</label>
                                            <img src="<?php echo $company_image; ?>" height="120" alt="company_img">
                                            <br><br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <input class="form-control" type="text" name="opening_hour" placeholder="Opening hour (Like - Mon - Wed, 10:00 AM - 12:00 PM)" value="<?php echo $opening_hour; ?>" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>About Company</label>
                                            <textarea class="form-control" rows="4" name="about_company" placeholder="Something about your company..." required><?php echo $about_company; ?></textarea>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label>Company Address</label>
                                            <textarea class="form-control" rows="4" name="company_address" placeholder="Company address" required><?php echo $company_address; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>Company Services</label>
                                            <textarea class="form-control" name="company_services" id="company_services" required><?php echo $company_services; ?></textarea>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label>Company Established On (*ex: M-D-Y)</label>
                                            <input class="form-control" type="date" name="company_established_on" value="<?php echo $company_established_on; ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Way of Payment</label>
                                        <input class="form-control" type="text" name="way_of_payment" value="<?php echo $way_of_payment; ?>" placeholder="Way of payment" required>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>Bkash Accout Number</label>
                                            <input class="form-control" type="text" name="bkash_acc_number" placeholder="Your bkash account number" value="<?php echo $bkash_acc_number; ?>" required>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label>Nagad Accout Number</label>
                                            <input class="form-control" type="text" name="nagad_acc_number" placeholder="Your nagad account number" value="<?php echo $nagad_acc_number; ?>" required>
                                        </div>
                                    </div>
