<?php
 ...
 <?php
   ...
   if(isset($_GET['event_package_id']))
   {
     ...
     $sql     = "SELECT * FROM tb_event_package WHERE event_package_id = $event_package_id";
...
<!--Update Event Package Details -->
  <?php
   ...
   if(isset($_POST['update']))
   {
         ...
         $sql = "UPDATE tb_event_package SET package_name='$package_name',package_price='$package_price',package_details='$package_details',package_added_on='$package_added_on' WHERE event_package_id = $event_package_id";
         ...
         <script type="text/javascript">
           ...
           window.alert("Event Package details updated successfully.");
...
<head>
    ...
    <title>Divine Planners - Update Event Package | Event Planner Panel</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Update Event Package</h1>
                <ol class="breadcrumb">
