<?php
 ...
 ?>
  ...
  <!-- Customer Feedback table data load -->
 <?php
...
<head>
    ...
    <title>Divine Planners - Customer Feedback | Event Planner Panel</title>
    ...
    <div class="page-wrapper">
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="customer_feedback.php"><i class="sidebar-item-icon fa fa-star-half-o"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-content fade-in-up">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Customer Feedback List</div>
                    </div>
                    <div class="ibox-body">
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <?php if($read_customer_review){ $i = 0; ?>
                                                <?php while($result = $read_customer_review->fetch_assoc()){ $i = $i + 1; ?>
                                                <tr>
                                                    <td class="text-success" style="font-weight: bold;"><?php echo "Feedback Id-".$result['review_id']; ?></td>
                                                    ...
                                                    <td>
                                                        <a onclick="return confirm('Sure to delete?')" href="delete_data.php?review_id=<?php echo $result['review_id']; ?>" title="delete" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a>
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                                  <?php }else{ ?>
