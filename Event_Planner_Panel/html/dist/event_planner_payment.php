<?php
 ...
 <?php
   ...
   {    
         ...
         $dst                = "./event_panner_payment_img/".$tmp.$payment_screenshot;
         $dst_db             = "event_panner_payment_img/".$tmp.$payment_screenshot;
         move_uploaded_file($_FILES["payment_screenshot"]["tmp_name"],$dst);

         $sql = "INSERT INTO tb_event_planner_payment(payment_code,event_planner_id,company_name,company_code,contact_number,email_address,paid_amount,trx_id,payment_method,payment_acc_number,payment_screenshot,payment_date,added_by,entry_time)values('$payment_code','$event_planner_id','$company_name','$company_code','$contact_number','$email_address','$paid_amount','$trx_id','$payment_method','$payment_acc_number','$dst_db','$payment_date','$added_by','$current_datetime')";
         ...
         if($insert_row)
         {
           ...
           <script type="text/javascript">
             ...
             window.location='event_planner_payment.php?event_planner_id=<?php echo $event_planner_id; ?>';
           </script>
                    ...
                    <div class="col-md-6">
                        <div class="ibox">
                            ...
                            <div class="ibox-body">
                                ...
                                <p>**You have to pay total 500 Tk. per event.</p>
