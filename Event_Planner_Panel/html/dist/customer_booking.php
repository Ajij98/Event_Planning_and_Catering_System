...
<head>
    ...
    <title>Divine Planners - Customer Booking | Event Planner Panel</title>
    ...
    <div class="page-wrapper">
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="customer_booking.php"><i class="sidebar-item-icon fa fa-arrow-down"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Manage Customer Booking</h1>
                <ol class="breadcrumb">
            ...
            <div class="page-content fade-in-up">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Customer Booking List</div>
                    </div>
                    <div class="ibox-body">
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-primary font-weight-bold"><?php echo "Booking Id-".$result['booking_id']; ?></td>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            {
                                            ?>
                                                <a href="customer_booking_confirmation.php?booking_id=<?php echo $result['booking_id']; ?>" onclick="return confirm('Sure to confirm booking?')" class="btn btn-success btn-rounded btn-sm" >Confirm Booking</a>
                                            <?php
                                            }
                                        ?>
                                    </td>
                                    <td>
                                        <a href="delete_data.php?booking_id=<?php echo $result['booking_id']; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                                <?php }else{ ?>
