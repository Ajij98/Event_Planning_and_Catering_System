<?php
 ...
 <?php
   ...
   $db              = new Database();
   $sql             = "SELECT * FROM tb_booking_payment WHERE company_owner = '$user_name'";
...
<head>
    ...
    <title>Divine Planners - Booking Payment | Event Planner Panel</title>
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="booking_payment.php"><i class="sidebar-item-icon fa fa-money"></i>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            {
                                            ?>
                                                <a href="booking_payment_verification.php?payment_id=<?php echo $result['payment_id']; ?>" onclick="return confirm('Sure to accept payment?')" class="btn btn-success btn-rounded btn-sm" >Accept Payment</a>
                                            <?php
                                            }
                                        ?>
                                    </td>
                                    <td>
                                        <a href="delete_data.php?payment_id=<?php echo $result['payment_id']; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                                <?php }else{ ?>
