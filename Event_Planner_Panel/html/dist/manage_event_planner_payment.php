<?php
 ...
 <?php
   ...
   $db              = new Database();
   $sql             = "SELECT * FROM tb_event_planner_payment WHERE added_by = '$user_name'";
...
<head>
    ...
    <title>Divine Planners - Event Planner Payment | Event Planner Panel</title>
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="manage_event_planner_payment.php"><i class="sidebar-item-icon fa fa-money"></i>
