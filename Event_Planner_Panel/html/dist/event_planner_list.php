<?php
 ...
 <!-- Event Planner List Table Data Load -->
 <?php
...
<head>
    ...
    <title>Divine Planners - Event Planner List | Event Planner Panel</title>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="add_event_package.php?event_planner_id=<?php echo $result['event_planner_id']; ?>" class="btn btn-primary px-2 py-1" style="border-radius: 3px;"><i class="fa fa-plus"></i> Add Package</a>
                                    </td>
