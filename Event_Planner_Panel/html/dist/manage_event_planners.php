...
<head>
    ...
    <title>Divine Planners - Manage Event Planners | Event Planner Panel</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Manage Event Planners</h1>
                <ol class="breadcrumb">
            ...
            <div class="page-content fade-in-up">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Event Planner List</div>
                    </div>
                    <div class="ibox-body">
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-primary font-weight-bold"><?php echo "Company Id-".$result['event_planner_id']; ?></td>
                                    <td><img src="<?php echo $result['company_image'] ?>" height="70" alt="event_panner_img"></td>
                                    <td style="font-weight: bold;"><?php echo $result['company_name']; ?></td>
                                    <td><?php echo $result['contact_number']; ?></td>
                                    <td><input type="text" value="<?php echo $result['company_address']; ?>"></td>
                                    <td><?php echo $result['opening_hour']; ?></td>
                                    <td><?php echo $result['company_established_on']; ?></td>
                                    <td>
                                        <?php
                                            ...
                                            if($is_verified == 1)
                                            {
                                                $msg = '<div class="m-auto badge badge-success" style="border-radius: 15px;">Verified</div><br />';
                                                    echo $msg;
                                            }
                                            else
                                            {
                                    ...
                                    <td>
                                        <a href="event_planner_payment.php?event_planner_id=<?php echo $result['event_planner_id']; ?>" class="btn btn-success btn-rounded btn-sm">Make Payment</a>
                                    </td>
                                    <td>
                                        <a href="update_event_planner.php?event_planner_id=<?php echo $result['event_planner_id']; ?>" title="update" class="btn btn-info btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-pencil"></i></a> <a href="delete_data.php?event_planner_id=<?php echo $result['event_planner_id']; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                                <?php }else{ ?>
