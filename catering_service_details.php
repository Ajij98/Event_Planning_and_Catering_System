<?php
 ...
 <!-- Select Catering Service Details -->
 <?php
  ...
  <!-- Catering Service Package Card Data Load -->
 <?php
   $user_name       = $_SESSION['user_name'];
   $db              = new Database();
   $sql             = "SELECT * FROM tb_catering_package WHERE company_id = $caterer_id";
   $read_catering_package = $db->select($sql);
  ?>
 ...
 <?php
   $db   = new Database();
   $sql  = "SELECT * FROM tb_review WHERE company_id = $caterer_id AND company_owner = '$added_by'";
 ...
 <?php
     $db   = new Database();
     $sql  = "SELECT * FROM tb_review WHERE company_id = $caterer_id";
...
<?php
   $db   = new Database();
   $sql  = "SELECT sum(rating_value)rating_value FROM tb_review WHERE company_id = $caterer_id";
...
<head>
    ...
    <title>Divine Planners - Catering Service Details</title>
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
                <div class="container d-flex align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Catering Service Details</li>
                    </ol>
                </div><!-- End .container -->
                            ...
                            <div class="col-md-4 bg-light pt-1 pb-4" style="border-radius: 5px; border-top: 1px solid #86A0B6;">
                                ...
                                <div class="row">
                                    <div class="col-4 mb-1">
                                        <img id="myImg_1" style="border-radius: 5px;" src="assets/event_img/bg-2.jpg" data-zoom-image="assets/event_img/bg-2.jpg" alt="catering_service_image">
                                        <!-- The Modal -->
                                    ...
                                    <div class="col-4 mb-1">
                                        <img id="myImg" style="border-radius: 5px;" src="assets/event_img/bg-9.jpg" data-zoom-image="assets/event_img/bg-9.jpg" alt="catering_service_image">
                                        <!-- The Modal -->
                                    ...
                                    <div class="col-4 mb-1">
                                        <img id="myImg_3" style="border-radius: 5px;" src="assets/event_img/bg-8.jpg" data-zoom-image="assets/event_img/bg-8.jpg" alt="catering_service_image">
                                        <!-- The Modal -->
                                    ...
                                    <div class="col-4 mb-1">
                                        <img id="myImg_4" style="border-radius: 5px;" src="assets/event_img/bg-1.jpg" data-zoom-image="assets/event_img/bg-1.jpg" alt="catering_service_image">
                                        <!-- The Modal -->
                                    ...
                                    <div class="col-4 mb-1">
                                        <img id="myImg_5" style="border-radius: 5px;" src="assets/event_img/bg-5.jpg" data-zoom-image="assets/event_img/bg-5.jpg" alt="catering_service_image">
                                        <!-- The Modal -->
                                ...
                                <p class="text-center"><a href="login.php" class="text-dark" style="font-family: sans-serif; font-size: 18px; text-decoration: underline;"><i class="fa fa-exclamation-triangle fa-fw text-warning"></i> Click here to login to view more info!</a></p>

                                <p class="text-muted text-center mt-2">Don't have any account to login? (লগইন করার জন্য আপনার কি কোনো একাউন্ট নেই ?)</p>

                                <p class="text-center text-info fa-2x"><i class="fa fa-hand-o-down"></i></p>

                                <p class="text-center"><a href="registration.php" class="btn btn-round py-2 btn-outline-info" >Create New Account (নতুন একাউন্ট খুলুন)</a></p>
                            ...
                            <div class="col-md-7 ml-2" style="border: 1px solid #E4E4E4; border-radius: 5px;">
                                ...
                                <div class="product-details-tab">
                                    <ul class="nav nav-pills justify-content-center" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="event-packages-link" data-toggle="tab" href="#event-packages-tab" role="tab" aria-controls="event-packages-tab" aria-selected="true">CATERING PACKAGES</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="event-packages-tab" role="tabpanel" aria-labelledby="event-packages-link">
                                            <div class="row">
                                                ...
                                                <?php if($read_catering_package){ $i = 0; ?>
                                                <?php while($result = $read_catering_package->fetch_assoc()){ $i = $i + 1; ?>
                                                <div class="col-md-6">
                                                    <div class="product product-2 shadow text-center" style="border-radius: 5px;">
                                                            <div class="product-body py-4">
                                                                ...
                                                                <h3 class="product-title text-dark" style="font-family: 'Rajdhani', sans-serif; font-size: 20px;"><?php echo $result['package_details']; ?></h3><!-- End .product-title -->
                                            ...
                                            <div><hr class="mb-0"></div>
                                                ...
                                                <p class="mb-2"><i class="fa fa-mouse-pointer fa-fw" aria-hidden="true"></i> Click over the button to book new catering service. Thank You! (নতুন ক্যাটারিং সার্ভিস বুক করতে নিচের বুক নিউ সার্ভিস বাটনে ক্লিক করুন। ধন্যবাদ!)</p>
                                                <div class="text-center">
                                                    <a href="login.php" class="btn btn-info btn-round">Book New Service</a>
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="payment-info-tab" role="tabpanel" aria-labelledby="payment-info-link">
                                            <div class="product-desc-content">
                                                ...
                                                <p class="text-center"><a href="login.php" class="btn btn-round py-2 btn-warning" style="color: white;">Login to view payment info</a></p>
