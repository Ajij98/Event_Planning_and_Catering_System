<?php
 ...
 <?php
   ...
   if(isset($_GET['booking_id']))
   {
     ...
     $sql     = "SELECT * FROM tb_event_catering_booking WHERE booking_id = $booking_id";
     ...
     {  
         ...
         $booking_code  = $getData['booking_code'];
         $company_owner = $getData['company_owner'];
     }
   }
  ?>
 ...
 <?php
   ...
   if(isset($_POST['submit']))
   {
         ...
         $sql = "INSERT INTO tb_booking_payment(payment_code,name,contact,paid_amount,trx_id,payment_acc_number,payment_date,booking_id,booking_code,paid_by,company_owner,entry_time)values('$payment_code','$name','$contact','$paid_amount','$trx_id','$payment_acc_number','$payment_date','$booking_id','$booking_code','$paid_by','$company_owner','$current_datetime')";
         ...
         if($insert_row)
         {
           ...
           <script type="text/javascript">
             window.alert("Your booking payment submitted successfully. Please check your booking payment history!");
                    ...
                    <div class="product-details-top">
                        <div class="row">
                          ...
                          <div class="col-9 m-auto shadow px- py-4" style="border-radius: 5px; border-top: 1px solid #86A0B6;">
                            ...
                            <h6 style="color: #86A0B6;">Booking Payment</h6><hr class="mt-0 mb-1">
                            ...
                            <form class="px-4 py-4" action="#" method="post" enctype="multipart/form-data" autocomplete="off">
                                  ...
                                  <div class="row">
                                    <div class="col-sm-6">
                                      ...
                                      <input type="text" name="payment_acc_number"  class="form-control" required>
                                    </div>
                                  ...
                                  <div class="row">
                                    <div class="col-sm-6">
                                      ...
                                      <input type="text" name="booking_id"  class="form-control" value="<?php echo $booking_id; ?>" readonly>
                                    </div>

                                    <div class="col-sm-6">
                                      <label>Booking Code *</label>
                                      <input type="text" name="booking_code"  class="form-control" value="<?php echo $booking_code; ?>" readonly>
                                    </div>
                                  </div>

                                <input type="submit" name="submit" class="btn btn-round shadow" style="background-color: #86A0B6; color: white;" value="Submit Payment">
