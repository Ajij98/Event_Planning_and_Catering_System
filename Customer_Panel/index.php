                        ...
                        <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            ...
                            <div class="product product-2 shadow" style="border-radius: 5px;">
                                <figure class="product-media">
                                    ...
                                    <a href="event_planning_details.php?event_planner_id=<?php echo $result['event_planner_id']; ?>">
                                        <img src="<?php echo '../Service_Panel/html/dist/'.$result['company_image'] ?>" alt="Product image" class="product-image">
                                    </a>

                                    <div class="product-action">
                                        <a href="event_planning_details.php?event_planner_id=<?php echo $result['event_planner_id']; ?>" class="btn-product" style="font-size: 15px;"><p>Book Appointment</p ></a>
                                ...
                                <div class="product-body py-4">
                                    ...
                                    <h3 class="product-title"><a href="event_planning_details.php?event_planner_id=<?php echo $result['event_planner_id']; ?>" style="color: #86A0B6; font-family: 'Rajdhani', sans-serif; font-size: 20px;"><b><?php echo $result['company_name']; ?></b></a></h3><!-- End .product-title -->
                                    <div class="mt-1">
