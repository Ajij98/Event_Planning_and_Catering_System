   ...
   {    
         ...
         if($insert_row)
         {
           ...
           <script type="text/javascript">
             ...
             window.location='catering_service_details.php?caterer_id=<?php echo $caterer_id; ?>';
           </script>
...
<head>
    ...
    <title>Divine Planners - Book Catering Service</title>
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
                <div class="container d-flex align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="catering_service_details.php?caterer_id=<?php echo $caterer_id; ?>">Catering Service Details</a></li>
                    ...
                    <div class="product-details-top">
                        <div class="row">
                          ...
                          <div class="col-9 m-auto shadow px- py-4" style="border-radius: 5px; border-top: 1px solid #86A0B6;">
                            ...
                            <h6 style="color: #86A0B6;">Book Catering Service</h6><hr class="mt-0 mb-1">
                            ...
                            <form class="px-4 py-4" action="#" method="post" enctype="multipart/form-data" autocomplete="off">
                                  ...
                                  <label>Message to caterer (If Any) </label>
