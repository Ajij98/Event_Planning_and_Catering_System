        ...
        if(check_Buy_Product())
        {
          if(check_Duplicate_Review())
          {
            ...
            <script type="text/javascript">
              ...
              window.location="event_planning_details.php?event_planner_id=<?php echo $company_id; ?>";
...
<head>
    ...
    <title>Divine Planners - Review (Event Planning)</title>
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
                <div class="container d-flex align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="event_planning_details.php?event_planner_id=<?php echo $company_id; ?>">Event Planning Details</a></li>
