                                        ...
                                        <div class="tab-pane fade show active" id="event-packages-tab" role="tabpanel" aria-labelledby="event-packages-link">
                                            ...
                                            <div><hr class="mb-0"></div>
                                                ...
                                                <div class="text-center">
                                                    <a href="catering_service_booking.php?company_id=<?php echo $caterer_id; ?>" class="btn btn-info btn-round">Book New Service</a> || 

                                                    <a href="catering_service_review.php?company_id=<?php echo $caterer_id; ?>" class="btn btn-success btn-round">Give Us Feedback</a>
                                                </div>
