<?php
 ...
 <!-- Registered Event_Planner/Caterer table data load -->
 <?php
   $user_name = $_SESSION['user_name'];
   $db   = new Database();
   $sql  = "SELECT * FROM tb_user WHERE user_type='Event Planner' || user_type='Catering Service' || user_type='Event Planner & Catering Service'";
...
<head>
    ...
    <title>Divine Planners - Registered Planner/Caterer | Admin Panel</title>
    ...
    <div class="page-wrapper">
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="registered_planner_and_caterer.php"><i class="sidebar-item-icon fa fa-users"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Registered Planner/Caterer</h1>
                <ol class="breadcrumb">
            ...
            <div class="page-content fade-in-up">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Planner/Caterer List</div>
                    </div>
                    <div class="ibox-body">
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>Planner/Caterer Id</th>
                                    <th>Planner/Caterer Name</th>
                                    <th>Email</th>
                                    <th>Phone</th>
                                    <th>Address</th>
                                    <th>User Type</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-primary font-weight-bold"><?php echo 'User Id-'.$result['user_id']; ?></td>
                                    <td><?php echo $result['name']; ?></td>
                                    <td><?php echo $result['email']; ?></td>
                                    <td><?php echo $result['phone']; ?></td>
                                    <td><?php echo $result['address']; ?></td>
                                    <td class="text-success"><?php echo $result['user_type']; ?></td>
                                    <td>
                                        <a href="delete_data.php?planner_caterer_user_id=<?php echo $result['user_id']; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                                <?php }else{ ?>
