<?php
 ...
 <?php
   ...
   $db              = new Database();
   $sql             = "SELECT * FROM tb_event_planner";
...
<head>
    ...
    <title>Divine Planners - Manage Event Planners | Admin Panel</title>
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="manage_event_planners.php"><i class="sidebar-item-icon fa fa-address-book-o"></i>
                            <span class="nav-label">Manage Event Planner</span>
                        </a>
                    </li>
                    <li>
                        <a href="event_panner_payment.php"><i class="sidebar-item-icon fa fa-money"></i>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo '../../../Service_Panel/html/dist/'.$result['company_image'] ?>" height="70" alt="event_panner_img"></td>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            if($is_verified == 1)
                                            {
                                                $msg = '<div class="m-auto badge badge-success" style="border-radius: 15px;">Activated</div><br />';
                                                    echo $msg;
                                            }
                                            else
                                            {
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            {
                                            ?>
                                                <a href="event_planer_activation.php?event_planner_id=<?php echo $result['event_planner_id']; ?>" onclick="return confirm('Sure to active event?')" class="btn btn-success btn-rounded btn-sm" >Active Event</a>
                                            <?php
                                            }
                                        ?>
                                    </td>
                                    <td>
                                        <a href="delete_data.php?event_planner_id=<?php echo $result['event_planner_id']; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                                <?php }else{ ?>
