...
<head>
    ...
    <title>Divine Planners - Manage Caterer | Admin Panel</title>
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="manage_caterer.php"><i class="sidebar-item-icon fa fa-cutlery"></i>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo '../../../Service_Panel/html/dist/'.$result['company_image'] ?>" height="70" alt="caterer_img"></td>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            {
                                            ?>
                                                <a href="catering_service_activation.php?caterer_id=<?php echo $result['caterer_id']; ?>" onclick="return confirm('Sure to active caterer?')" class="btn btn-success btn-rounded btn-sm" >Active Caterer</a>
                                            <?php
                                            }
                                        ?>
                                    </td>
                                    <td>
                                        <a href="delete_data.php?caterer_id=<?php echo $result['caterer_id']; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm px-2 py-1" style="border-radius: 3px;"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                                <?php }else{ ?>
